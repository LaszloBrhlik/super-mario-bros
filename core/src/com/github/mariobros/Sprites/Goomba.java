...
public class Goomba extends Enemy {
  private static final int GOOMBA_STARTING_POS_X = 32;
  private static final int GOOMBA_STARTING_POS_Y = 32;
  ...
  protected void defineEnemy() {
    bdef = new BodyDef();
    bdef.position.set(GOOMBA_STARTING_POS_X / MarioBros.PPM, GOOMBA_STARTING_POS_Y / MarioBros.PPM);
